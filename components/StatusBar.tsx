// components/antigravity/StatusBar.tsx
"use client";
      ...
      <div className="flex items-center space-x-3 text-[11px]">
        ...
        <Tooltip>
          ...
          <TooltipContent
            ...
            className="text-xs bg-[#1f1f1f] text-zinc-200 border-[#3c3c3c]"
          >
            Toggle Google Antigravity physics floating effect
          </TooltipContent>
        </Tooltip>
        ...
        <Tooltip>
          ...
          <TooltipContent
            ...
            className="text-xs bg-[#1f1f1f] text-zinc-200 border-[#3c3c3c]"
          >
            Toggle Antigravity AI Reasoning Copilot (⌘L)
          </TooltipContent>
        </Tooltip>
