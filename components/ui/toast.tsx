...
type ToastFn = {
  ...
  add: typeof baseToastManager.add;
  close: typeof baseToastManager.close;
  update: typeof baseToastManager.update;
  promise: typeof baseToastManager.promise;
  ...
  " subscribe": (typeof baseToastManager)[" subscribe"];
};

const toast = ((title: React.ReactNode, options?: ToastOptions) => {
...
toast.add = baseToastManager.add.bind(baseToastManager);
toast.close = baseToastManager.close.bind(baseToastManager);
toast.update = baseToastManager.update.bind(baseToastManager);
toast.promise = baseToastManager.promise.bind(baseToastManager);
toast[" subscribe"] = baseToastManager[" subscribe"].bind(baseToastManager);
